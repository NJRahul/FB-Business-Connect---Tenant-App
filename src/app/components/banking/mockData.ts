...
export const MOCK_VAULTS: BankingVault[] = [
  { id: 'v1', shop_id: 'shop1', account_id: 'acc1', name: 'Operating',          balance_cached: 538306, target_balance: 600000, currency: 'ZAR', is_default: true,  sort_order: 0 },
  { id: 'v2', shop_id: 'shop1', account_id: 'acc1', name: 'Tax Reserve',         balance_cached: 189500, target_balance: 250000, currency: 'ZAR', is_default: false, sort_order: 1 },
  { id: 'v3', shop_id: 'shop1', account_id: 'acc1', name: 'Parts & Inventory',   balance_cached: 114535, target_balance: undefined,               currency: 'ZAR', is_default: false, sort_order: 2 },
];
...
export const MOCK_TRANSFERS: BankingTransfer[] = [
  ...
  { id: 'txfr3', shop_id: 'shop1', account_id: 'acc1', type: 'ach_out', counterparty_id: 'cp2', counterparty_name: 'Landlord – Main St.', from_vault_id: 'v1', from_vault_name: 'Operating', to_vault_id: null, to_vault_name: null, amount: 250000, currency: 'ZAR', status: 'scheduled', scheduled_for: '2026-10-01T08:00:00Z', recurrence_json: { frequency: 'monthly', day_of_month: 1 }, initiated_by: 'Owner', approved_by: null, approval_status: 'not_required', idempotency_key: 'idem_3', partner_transfer_id: null, created_at: '2026-09-01T10:00:00Z' },
];
...
export const MOCK_UPCOMING_OBLIGATIONS = [
  { id: 'ob1', label: 'Rent – Main St.',           amount: 250000, currency: 'ZAR', due: '2026-10-01', type: 'scheduled_transfer' },
  { id: 'ob2', label: 'FB Business Connect Subscription',      amount: 49900,  currency: 'ZAR', due: '2026-09-28', type: 'subscription' },
  { id: 'ob3', label: 'ATD Parts Invoice #88299',  amount: 124000, currency: 'ZAR', due: '2026-09-20', type: 'bill_pay' },
];
...
export const FEE_SCHEDULE = [
  ...
  { feature: 'Instant payout',         fee: '1.5% of payout (min R 5)' },
  { feature: 'Domestic EFTs',          fee: 'R 350 / wire (Enterprise)' },
  { feature: 'Physical card',          fee: 'Free (1 per user)' },
  { feature: 'Card replacement',       fee: 'R 75 / card' },
  { feature: 'International txns',     fee: '3% of amount' },
  { feature: 'Paper statements',       fee: 'R 75 / statement' },
