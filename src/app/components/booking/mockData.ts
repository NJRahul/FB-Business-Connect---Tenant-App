...
export const CUSTOMERS: CustomerRecord[] = [
  {
    ...
    address: '412 Maple St, Irving, TX 75038',
    vehicles: [
  ...
  },
  {
    ...
    address: '8821 Oak Ave, Dallas, TX 75001',
    vehicles: [
  ...
  },
  {
    ...
    address: '2200 Commerce Dr, Carrollton, TX 75006',
    vehicles: [
...
export const VISITS: Visit[] = [
  // ── Today (in-progress) ──
  {
    ...
    serviceAddress: '412 Maple St, Irving, TX 75038', operationsType: 'mobile',
  ...
  // ── Upcoming Mon June 15 ──
  {
    ...
    serviceAddress: '123 Main St, Dallas, TX 75001', operationsType: 'inshop',
  ...
  },
  {
    ...
    technicianId: 'tech-1', technicianName: 'Mike Torres',
    serviceAddress: '2200 Commerce Dr, Carrollton, TX 75006', operationsType: 'inshop',
  ...
  // ── Completed visits ──
  {
    ...
    technicianId: 'tech-1', technicianName: 'Mike Torres',
    serviceAddress: '8821 Oak Ave, Dallas, TX 75001', operationsType: 'inshop',
    vehicle: { year: '2021', make: 'Toyota', model: 'Camry', trim: 'SE', licensePlate: 'TX-DEF456' },
