...
export const MOCK_FLEET_ACCOUNTS: FleetAccount[] = [
  {
    ...
    ein: '12-3456789',
    status: 'active',
    billingContact: { name: 'James Turner', email: 'james.turner@acme.com', phone: '+27 11 201 0001', title: 'Fleet Director' },
    apContact: { name: 'Linda Park', email: 'ap@acme.com', phone: '+27 11 201 0002', title: 'AP Manager' },
    ...
    authorizedBuyers: [
      { id: 'buyer_001', fleetAccountId: 'fleet_001', name: 'James Turner', email: 'james.turner@acme.com', phone: '+27 11 201 0001', role: 'fleet_manager', spendLimitPerTransaction: null, spendLimitPerPeriod: null, vehicleScope: 'all', active: true },
