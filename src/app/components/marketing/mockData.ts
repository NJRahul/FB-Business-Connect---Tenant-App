...
export const CAMPAIGNS: Campaign[] = [
  {
    ...
    content: {
      ...
      ctaLabel: 'Book My Appointment', ctaUrl: 'https://shop.tdforge.app/book?utm_campaign=cmp-1&utm_source=email',
      promoCode: 'WINBACK15',
    },
  ...
  },
  {
    ...
    content: {
      ...
      ctaLabel: 'View Winter Tires', ctaUrl: 'https://shop.tdforge.app/winter?utm_campaign=cmp-2',
    },
  ...
  },
  {
    ...
    content: {
      ...
      smsText: '{{first_name}}, you\'re a TDforge VIP! Enjoy a FREE tire rotation on your next visit — just say "VIP THANKS" when booking. [link] STOP to opt out.',
      ctaLabel: 'Book Free Rotation', ctaUrl: 'https://shop.tdforge.app/book?utm_campaign=cmp-3',
    },
    attributionWindowDays: 30,
    stopWhenConditions: ['books_appointment', 'unsubscribes'],
    startWhenTrigger: 'manual',
  ...
  },
  {
    ...
    content: {
      ...
      ctaLabel: 'Leave a Review', ctaUrl: 'https://shop.tdforge.app/review?utm_campaign=cmp-4',
    },
